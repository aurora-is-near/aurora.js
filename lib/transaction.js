...
export class Transaction {
    ...
    static fromSubmitCall(outcome, functionCall) {
        try {
            ...
            Address.parse(transaction.to).ok(), BigInt(transaction.value.toString()), transaction.data, BigInt(transaction.v), BigInt(transaction.r), BigInt(transaction.s), transaction.from
