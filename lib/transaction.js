...
export class Transaction {
    ...
    static fromSubmitCall(outcome, functionCall) {
        try {
            ...
            Address.parse(transaction.to).ok(), BigInt(transaction.value.toString()), Buffer.from(transaction.data, 'hex'), BigInt(transaction.v), BigInt(transaction.r), BigInt(transaction.s), transaction.from
